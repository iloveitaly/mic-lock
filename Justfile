build:
    ...
    @echo "Binary: {{justfile_directory()}}/.build/apple/Products/Release/miclock"
...
github_repo_set_metadata:
    @gh repo edit \
      --description "Mic preference manager with priority fallback" \
      --homepage "https://github.com/iloveitaly/mic-lock"
